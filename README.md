...
5) Put the downloaded `FNews-X.X.jar` into the `plugins` folder.
...
- **/fnews-reload** — Reloads the plugin and applies changes from the configuration file.
