...
public class FNews extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getLogger().info("Running FNews 5.0");
    ...
    public void onDisable() {
        ...
        getLogger().info(ChatColor.GREEN + "Running FNews 5.0");
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (label.equalsIgnoreCase("timer")) {
            if (!sender.hasPermission("fnews.timer")) {
                sender.sendMessage(ChatColor.RED + "Sorry, but you don't have a permission to use timer.");
                return true;
            }
            ...
            if (seconds <= 0) {
                sender.sendMessage(ChatColor.RED + "Sorry, this is unknown time format.");
                return true;
            }

            timerManager.startTimer(seconds);
